...
public class Additional_tests extends TestBaseForRegistration {
    ...
    public void incorrectOneEmptyFields(String name, String org, String email) throws InterruptedException, IOException {
      ...
      //  assertThat(language + ": " + app.getRegistrationHelper().getTextError(field), app.getRegistrationHelper().getTextError(field), equalTo(Constant.getEmptyErrorLanguage(language)));
        ...
        assertThat(language + ": " + app.getRegistrationHelper().getTextError(field), app.getRegistrationHelper().getTextError(field), equalTo(app.getYamlHelper().getEmptyErrorLanguage(language)));
    ...
    public void checkMainRegistrationPage() throws InterruptedException, IOException {
       ...
       assertThat(language + ": " + app.getRegistrationHelper().getText(Constant.TITLE), app.getRegistrationHelper().getText(Constant.TITLE), equalTo(app.getYamlHelper().getTitleLanguage(language)));
    ...
    @Test(priority = 3, groups = "ChangeLanguage")
    public void checkMainRegistrationPageDescription() throws InterruptedException, IOException {
        log.log(Level.INFO, "Additional test. Check main  registration. Lang: " + language);
      ...
      //  assertThat(language + ": " + app.getRegistrationHelper().getText(Constant.DESCRIPTION), app.getRegistrationHelper().getText(Constant.DESCRIPTION), equalTo(Constant.getDescriptionLanguage(language)));
        assertThat(language + ": " + app.getRegistrationHelper().getText(Constant.DESCRIPTION), app.getRegistrationHelper().getText(Constant.DESCRIPTION), equalTo(app.getYamlHelper().getDescriptionLanguage(language)));
    ...
    public void checkMainRegistrationPageCheckbox(String name, String org, String email) throws InterruptedException, IOException {
        log.log(Level.INFO, "Additional test. Check main  registration. Lang: " + language);
        app.getRegistrationHelper().fillRegistrationForm(name, org, email);
        app.getRegistrationHelper().clickRegisterButton();
        ...
        assertThat(language + ": " +app.getRegistrationHelper().getText(Constant.LICENCE_AGREE), app.getRegistrationHelper().getText(Constant.LICENCE_AGREE), equalTo(app.getYamlHelper().getCheckBoxText(language)));
    }
